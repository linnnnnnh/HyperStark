...
const AkarIconsGithubFillIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
      ...
      fill='url(#paint0_linear_180_115)'
    />
    <defs>
      <linearGradient
        id='paint0_linear_180_115'
        x1={0}
        y1={19.5066}
        x2={40}
        y2={19.5066}
...
const Memo = memo(AkarIconsGithubFillIcon);
export { Memo as AkarIconsGithubFillIcon };
